...
public class YellowManActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private Button btn_hands;
    private Button btn_clothes;
    private Button btn_feet;
    private Button btn_feetShadow;
    private Button btn_stroke;
    private Button btn_noPants;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_yellow_man);
        bindViews();
    }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.btn_feet:
                drawFeet(canvas);
                break;
            case R.id.btn_feetShadow:
                drawFeetShadow(canvas);
                break;
            case R.id.btn_stroke:
                drawBodyStroke(canvas);
                break;
            case R.id.btn_noPants:
                drawNoPants(canvas);
                break;
        }
    }

    public void drawYellow(Canvas canvas) {
        initParams();
        initPaint();
...
//        drawBodyStroke(canvas);//最后画身体的描边，可以摭住一些过渡的棱角
    ...
    public void drawNoPants(Canvas canvas) {
        initParams();
        initPaint();
        drawFeetShadow(canvas);//脚下的阴影
        drawFeet(canvas);//脚
...
//        drawClothes(canvas);//衣服
    ...
    private void initParams() {
        bodyWidth = Math.min(iv_canvas.getWidth(), iv_canvas.getHeight() * BODY_WIDTH_HEIGHT_SCALE) * BODY_SCALE;
        bodyHeigh = Math.min(iv_canvas.getWidth(), iv_canvas.getHeight() * BODY_WIDTH_HEIGHT_SCALE) / BODY_WIDTH_HEIGHT_SCALE * BODY_SCALE;

        mStrokeWidth = Math.max(bodyWidth / 50, mStrokeWidth);
        offset = mStrokeWidth / 2;

        bodyRect = new RectF();
        bodyRect.left = (iv_canvas.getWidth() - bodyWidth) / 2;
        bodyRect.top = (iv_canvas.getHeight() - bodyHeigh) / 2;
        ...
        handsHeight =  (iv_canvas.getHeight() + bodyHeigh) / 2   + offset - radius * 1.65f;
    }

    private void bindViews() {
        iv_canvas = (ImageView) findViewById(R.id.iv_yellow);

        btn_body = (Button) findViewById(R.id.btn_body);
        btn_eyes = (Button) findViewById(R.id.btn_eyes);
        btn_hands = (Button) findViewById(R.id.btn_hands);
        btn_clothes = (Button) findViewById(R.id.btn_clothes);
        btn_feet = (Button) findViewById(R.id.btn_feet);
        btn_feetShadow = (Button) findViewById(R.id.btn_feetShadow);
        btn_stroke = (Button) findViewById(R.id.btn_stroke);
        btn_noPants = (Button) findViewById(R.id.btn_noPants);

        btn_body.setOnClickListener(this);
        btn_eyes.setOnClickListener(this);
        btn_hands.setOnClickListener(this);
        btn_clothes.setOnClickListener(this);
        btn_feet.setOnClickListener(this);
        btn_feetShadow.setOnClickListener(this);
        btn_stroke.setOnClickListener(this);
        btn_noPants.setOnClickListener(this);
    }
    ...
    public void drawBodyStroke(Canvas canvas) {
        initPaint();
    ...
    public void drawClothes(Canvas canvas) {
        ...
        rect.left = (iv_canvas.getWidth() - bodyWidth) / 2 + offset;
        rect.top = (iv_canvas.getHeight() + bodyHeigh) / 2 - radius * 2 + offset;
...
//        canvas.drawArc(left + w/5,);
    ...
    public void drawEyesMouth(Canvas canvas) {
